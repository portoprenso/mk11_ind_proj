        ...
        <div className="footer-hero">
            ...
            <div className="footer-container">
                <div className="footer__devs">
                    <img className="footer__devs__img" src="https://cdn-prod.mortalkombat.com/static/netherrealm.svg" />
                    <img className="footer__devs__img" src="https://cdn-prod.mortalkombat.com/static/wb-games-logo.svg" />
                </div>
                <div className="footer__platforms">
                    <img className="footer__platforms__img" src="https://cdn-prod.mortalkombat.com/static/ps4_tm.svg" />
                    <img className="footer__platforms__img" src="https://cdn-prod.mortalkombat.com/static/ps5_tm.svg" />
                    <img className="footer__platforms__img" src="https://cdn-prod.mortalkombat.com/static/xbox-one.svg" />
                    <img className="footer__platforms__img" src="https://cdn-prod.mortalkombat.com/static/xbox-series-x.svg" />
                    <img className="footer__platforms__img" src="https://cdn-prod.mortalkombat.com/static/nintendo-switch.svg" />
                    <img className="footer__platforms__img" src="https://cdn-prod.mortalkombat.com/static/pc-digital-download-logo.svg" />
                    <img className="footer__platforms__img" src="https://cdn-prod.mortalkombat.com/static/stadia.svg" />
                </div>
